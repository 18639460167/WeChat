...
@implementation CommentInfoModel2
...
- (instancetype)initWithDic:(NSDictionary *)dic
{
    if (self = [super init])
    {
        ...
        {
            str = [NSString stringWithFormat:@"%@回复%@：%@",self.commentUserName,self.commentByUserName,self.commentText];
        }
        else
        {
            str  =[NSString stringWithFormat:@"%@：%@",self.commentUserName,self.commentText];
        }
