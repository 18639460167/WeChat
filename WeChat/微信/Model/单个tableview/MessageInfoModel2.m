...
////                [mutableAttrStr appendAttributedString:[[NSAttributedString alloc] initWithString:friendModel.userName]];
////                if ([nameArray containsObject:friendModel.userName])
////                {
////                    // 如果前面有人和我的名字重复
////                    friendModel.range = NSMakeRange(mutableAttrStr.length - friendModel.userName.length, friendModel.userName.length);
////                }
////                else
////                {
////                    friendModel.range = [mutableAttrStr.string rangeOfString:friendModel.userName];
////                }
////
...
////            [mutableAttrStr addAttributes:@{NSFontAttributeName : font} range:NSMakeRange(0, mutableAttrStr.length)];
...
////            }
////
////            model2.likeUsersAttributedText = mutableAttrStr;
////            // 算likeUser点赞人cell的rowHeight
////            model2.rowHeight = [mutableAttrStr.string boundingRectWithSize:CGSizeMake(kScreenWidth - kGAP - kAvatar_Size - 2*kGAP, CGFLOAT_MAX) font:font lineSpacing:3.0].height + 0.5 + 8 + 5;
...
////        if ([attrString.string isMoreThanOneLineWithSize:CGSizeMake(kScreenWidth-kGAP-kAvatar_Size-2*kGAP, CGFLOAT_MAX) font:font lineSpacing:3.0])
////        {//margin
...
////        }
////
////        self.mutableAttrStr = attrString;
////        // 算text的Layout
...
////        {
////            for (int i=1; i<self.messageSmallPics.count+1; i++)
////            {
////                a = i/3;
////                b = i%3;
////                if (b == 0)
...
////                }
////            }
////             jgg_height = (a+1)*image_width+kGAP*a;
////        }
////
...
//        self.headerHeight = CGRectGetMaxY(self.jggLayout.frameLayout)+kGAP;
        ...
        NSMutableArray <FriendInfoModel *>*likeUsers = [NSMutableArray array];
        self.likeUserNameArray = [NSMutableArray new];
        for (NSDictionary *friendInfoDic in dic[@"likeUsers"])
        {
        ...
        if (likeUsers.count)
        {
            ...
            {
                FriendInfoModel *friendModel = likeUsers[i];
                [self.likeUserNameArray addObject:friendModel.userName];
                //name0,name1,name2,name1
                [mutablAttrStr appendAttributedString:[[NSAttributedString alloc] initWithString:friendModel.userName]];
                if ([nameArray containsObject:friendModel.userName]) {//如果前面有人和我重复名字了
                    friendModel.range = NSMakeRange(mutablAttrStr.length-friendModel.userName.length, friendModel.userName.length);
