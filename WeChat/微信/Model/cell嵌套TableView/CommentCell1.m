...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier])
    {
        ...
        self.hyb_bottomOffsetToCell = 0.0; // cell地步距离为3.0个间隙
    }
    return self;
}
...
- (void)configCellWithModel:(CommentInfoModel1 *)model
{
    ...
    if ([text.string isMoreThanOneLineWithSize:CGSizeMake(kScreenWidth-kGAP-kAvatar_Size-2*kGAP, CGFLOAT_MAX) font:[UIFont systemFontOfSize:13.0] lineSpaceing:5.0])
    {
