...
#pragma mark --mainFuncation--
- (void)tapActionWithStrings:(NSArray<NSString *> *)strings tapClicked:(void (^)(NSString *, NSRange, NSInteger))tapClick
{
...
- (void)tapActionWithStrings:(NSArray<NSString *> *)strings deleate:(id<TapActionDelegate>)delegate
{
    [self getRangesWithStrings:strings];
