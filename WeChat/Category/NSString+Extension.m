...
- (CGSize)boundingRectWithSize:(CGSize)size paragraphStyle:(NSMutableParagraphStyle *)paragraphStyle font:(UIFont *)font
{
    ...
    NSStringDrawingOptions operations = NSStringDrawingUsesLineFragmentOrigin;
    CGRect rect = [attributeString boundingRectWithSize:size options:operations context:nil];
    
    // 文本高度减去字体高度小于等于行间距，判断当前只有一行
